...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPPanelPrincipal.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CODIFICACION HUFFMAN",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP,
                new java.awt.Font("Purisa", 1, 14))); // NOI18N
        ...
        jPPanelPrincipalLayout.setHorizontalGroup(
                jPPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPPanelPrincipalLayout.createSequentialGroup()
                                ...
                                .addGroup(jPPanelPrincipalLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLArchivoSeleccionado)
                                        .addGroup(jPPanelPrincipalLayout.createSequentialGroup()
                                                .addComponent(jTFRutaArchivo, javax.swing.GroupLayout.PREFERRED_SIZE,
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jPPanelPrincipal, javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jPPanelPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private class Eventos implements MouseListener, ActionListener {
        ...
        public void iniciarCodificacion() {
            ...
            objCodificacionHuffman.getObjArchivo().escribirInforme(objCodificacionHuffman.getObjArbol(),
                    objCodificacionHuffman.getCaracteresFinales(), objCodificacionHuffman.getCodigoHuffman());
            objCodificacionHuffman.getObjArchivo().escribirArchivoHuffman(objCodificacionHuffman.getCaracteresFinales(),
                    objCodificacionHuffman.getCodigoHuffman());
                ...
                switch (seleccion) {
                    case JFileChooser.APPROVE_OPTION: {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "El archivo " + jFCSelector.getSelectedFile().getName() + " fue cargado con exito");
                    };
                    break;
                    ...
                    case JFileChooser.ERROR_OPTION: {
                        JOptionPane.showMessageDialog(null, "Ocurrio un error intentado cargar el archivo "
                                + jFCSelector.getSelectedFile().getName());
                    };
                    break;
                }
            }
